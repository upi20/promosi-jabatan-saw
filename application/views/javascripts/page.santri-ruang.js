$(() => {
    ...
    $('#form-tambah').submit((ev) => {
        ...
        window.apiClient.santriRuang.insert(nama)
            .done((data) => {
                $.doneMessage('Berhasil ditambahkan.', 'Santri Ruang')
                addRow(data)

            })
            .fail(($xhr) => {
                $.failMessage('Gagal ditambahkan. data mungkin sudah ada.', 'Santri Ruang')
            }).
            always(() => {
